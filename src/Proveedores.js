...
import api from './api';
import { UserPlus, Trash2, MapPin, Search, Loader2 } from 'lucide-react';
...
const GestionProveedores = () => {
  ...
  // Mantenemos todas tus variables de estado originales
  ...
  // Variable para responsividad dentro del componente
  ...
  const agregarProveedor = async (e) => {
    ...
    // ACOMODO DE VARIABLES: Filtramos solo lo que la Entity acepta
    const datosParaEnviar = {
      nombre: nuevoProveedor.nombre,
      cuit: nuevoProveedor.cuit,
      direccion: nuevoProveedor.direccion,
      telefono: nuevoProveedor.telefono,
      // No incluimos localidad, provincia ni CP para evitar el error 400
    };

    try {
      await api.post('/api/proveedores', datosParaEnviar);
      ...
      <div style={{ ...styles.card, marginTop: '30px' }}>
        ...
        <div style={{ overflowX: 'auto' }}>
          <table style={styles.table}>
            ...
            <tbody>
              {cargando ? (
                <tr><td colSpan="4" style={styles.emptyState}><Loader2 style={{animation: 'spin 1s linear infinite'}} /> Cargando...</td></tr>
